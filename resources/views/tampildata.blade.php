        ...
        <div class="row">
            <form action="{{ route('updatedata', $data->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_pelamar" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->nama_pelamar }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="no_telepon" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="0{{ $data->no_telepon }}">
                </div>
